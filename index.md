...
<body style="background-color:#FFFFFF;">
   <div style="background-color:#243B55;padding:5px">
    ...
    <!--Objective-->
    <br><br><br>
    <div class="titles"><h2 onclick="objectivej();"><center>The problems it solved</center>
    <span ><center><button onclick="objectivej();">show objective</button></center></span></h2></div>
...
<!--Technology used-->
  ...
  <div style="display: none" id="tu" class="note"> <ol type="i"><li>Flutter</li><li>Firebase</li><li>Node.js</li></ol></div>


<div class="menu-log"><center><button onclick="window.location.href='https://w3docs.com';">Click Here to Download</button></center></div>
